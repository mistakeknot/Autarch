...
type Typography struct {
	// Font sizes (conceptual — terminals use fixed sizes, but these
	// control column widths for text containers).
	...
	// Line heights (number of empty lines between elements).
...
// Aligned with tiers.go thresholds where applicable.
...
// TokenPreset identifies which density preset is active.
